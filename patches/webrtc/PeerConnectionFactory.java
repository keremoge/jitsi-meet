...
public class PeerConnectionFactory {
   ...
   public static PeerConnectionFactory.Builder builder() {
      return new PeerConnectionFactory.Builder();
   }
   ...
   private static native PeerConnectionFactory nativeCreatePeerConnectionFactory(Context var0, PeerConnectionFactory.Options var1, long var2, long var4, long var6, VideoEncoderFactory var8, VideoDecoderFactory var9, long var10, long var12, long var14, long var16, long var18);
   ...
   private static native RtpCapabilities nativeGetRtpSenderCapabilities(long var0, MediaStreamTrack.MediaType var2);

   private static native RtpCapabilities nativeGetRtpReceiverCapabilities(long var0, MediaStreamTrack.MediaType var2);
   ...
   public static class InitializationOptions {
      ...
      public static PeerConnectionFactory.InitializationOptions.Builder builder(Context applicationContext) {
         return new PeerConnectionFactory.InitializationOptions.Builder(applicationContext);
      }
      ...
      public static class Builder {
         ...
         public PeerConnectionFactory.InitializationOptions.Builder setEnableInternalTracer(boolean enableInternalTracer) {
            this.enableInternalTracer = enableInternalTracer;
            return this;
         }
         ...
         public PeerConnectionFactory.InitializationOptions.Builder setNativeLibraryName(String nativeLibraryName) {
            this.nativeLibraryName = nativeLibraryName;
            return this;
         }

         public PeerConnectionFactory.InitializationOptions.Builder setInjectableLogger(Loggable loggable, Logging.Severity severity) {
            this.loggable = loggable;
